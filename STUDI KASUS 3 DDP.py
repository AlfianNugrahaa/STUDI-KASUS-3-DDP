# 1. Instalasi/input nilai ujian mahasiswa
...
# 2. perulangan input nilai ujian mahasiswa
...
while True:
    ...
    # 4. validasi input nilai ujian mahasiswa dan pengelompokan nilai
    try:
...
# 5. menampilkan seluruh nilai ujian mahasiswa, nilai lulus, dan nilai remedi
print("\n ==HASIL AKHIR==")
